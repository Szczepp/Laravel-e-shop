        ...
        <div class="form-row">
            <label>{{ __('Images') }}</label>
                <div class="custom-file">
                    <input type="file" name="images[]" accept="image/*" class="custom-file-input" id="customFile" multiple>
                    <labe class="custom-file-label" >
                        Product Images...
                    </labe>
                </div>
        </div>
        <div class="form-row">
            <button class="btn btn-primary btn-lg mt-3"> Create Product </button>
        </div>
    </form>
